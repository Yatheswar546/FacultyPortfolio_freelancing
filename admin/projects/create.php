            ...
            if(empty($title) || empty($description) || empty($category) || empty($file)){
                ...
                if($filetype == "jpg" || $filetype == "jpeg" || $filetype == "png"){
                    if(move_uploaded_file($_FILES['image']['tmp_name'],$target_file)){
                        $sql = mysqli_query($db,"INSERT INTO `projects`(`title`, `description`, `image`, `category`, `link`, `projectid`) VALUES ('$title','$description','$file','$category','$link','$projectid')");
                        if($sql){
                            $successmsg = "You have succesfully added a Project";
            ...
            <div class="content">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="link" class="text-input">
                    </div>
                    <div>
