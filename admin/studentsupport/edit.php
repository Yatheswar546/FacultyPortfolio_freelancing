<?php
    ...
    if($_SESSION['id'] == true){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'GET'){
            ...
            $id = $_GET['id'];
            $result = mysqli_query($db,"SELECT * FROM `studentactivities` WHERE id='$id'");
                ...
                if(isset($_FILES['image']['tmp_name']) && !empty($_FILES['image']['tmp_name'])) {
                    if($filetype == "jpg" || $filetype == "jpeg" || $filetype == "png"){
                        if(move_uploaded_file($_FILES['image']['tmp_name'],$target_file)){
                            $sql = mysqli_query($db,"UPDATE `studentactivities` SET `title`='$title',`description`='$description',`mainimage`='$file' WHERE id='$id'");
                            if($sql){
                                $successmsg = "You have succesfully Updated";
                                $file = $target_file;
                    ...
                    $sql = mysqli_query($db,"UPDATE `studentactivities` SET `title`='$title',`description`='$description' WHERE id='$id'");
                    if($sql){
