...
<body>
    ...
    <div class="main">
        ...
        <div class="content gallery">
            <h2 class="topic-heading">Gallery</h2>
            <div class="gallery-images">
            <?php
                // Assuming you have established the database connection ($db)
                
                // Retrieve all images from the eventimages table
                $result = mysqli_query($db, "SELECT images FROM `eventimages`");
                ...
                if (!empty($imagePaths)) {
                    $numRandomImages = 10; // Set the number of random images you want to display
                    
                    // Shuffle the image paths array randomly
                    shuffle($imagePaths);
                    
                    // Select n random image paths from the shuffled array
                    $randomImagePaths = array_slice($imagePaths, 0, $numRandomImages);
                    
                    // Display the random images
                    foreach ($randomImagePaths as $path) {
